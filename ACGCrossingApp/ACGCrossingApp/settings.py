"""
Django settings for ACGCrossingApp project.
...
SECRET_KEY = '-ofdi7j98qp12^*eib0k*+9$chh91-l*y-b-^o49&f#&7hjtvu'
...
ROOT_URLCONF = 'ACGCrossingApp.urls'
...
WSGI_APPLICATION = 'ACGCrossingApp.wsgi.application'
...
CELERY_BEAT_SCHEDULE = {
    'task-number-one': {
        'task': 'ACGCrossingApp.tasks.task_number_one',
